...
def BravePatch(prune_paths, special_cases, prune_dirs, additional_paths):
    ...
    # This is for when we pull in external repos directly and therefore can't
    # add an extra README.chromium file.
    ...
    l += [
        ...
        'node_modules',  # TODO(fmarier): handle these elsewhere
    ]
    prune_dirs = tuple(l)
